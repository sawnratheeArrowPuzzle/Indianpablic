    ...
    <div className="min-h-screen bg-[#FAF7F0] text-slate-900 flex flex-col selection:bg-amber-500 selection:text-white font-poppins w-full overflow-x-hidden">
      ...
      <header className="no-print bg-[#FFFDF9] border-b border-amber-900/15 shadow-xs w-full overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2.5 flex items-center justify-between gap-2">
          ...
          {/* Top Right Controls: QR Studio + Prominent Login + Discreet Mini Admin */}
          <div className="flex items-center space-x-1 sm:space-x-2 shrink-0">
            ...
            <button
              ...
              className="px-2 sm:px-3 py-1.5 rounded-xl bg-gradient-to-r from-emerald-800 to-teal-900 hover:from-emerald-900 hover:to-teal-950 text-white text-[11px] sm:text-xs font-bold flex items-center space-x-1 sm:space-x-1.5 border border-emerald-600 transition-all shadow-2xs cursor-pointer"
            ...
            <button
              ...
              className="px-3 sm:px-4 py-1.5 rounded-xl bg-gradient-to-r from-[#0B1E36] via-[#102A4C] to-[#1E3A8A] hover:from-[#081526] hover:to-[#172554] text-white text-xs font-bold flex items-center space-x-1.5 border border-amber-400/60 transition-all shadow-sm active:scale-95 cursor-pointer"
              title="Login with Google or Email"
            >
              <Lock className="w-3.5 h-3.5 text-amber-400 shrink-0" />
              <span className="font-montserrat tracking-wide">Login</span>
            </button>
            ...
            <button
              ...
              className="p-1.5 sm:px-2.5 sm:py-1.5 rounded-xl bg-slate-100 hover:bg-amber-100 text-slate-700 hover:text-amber-900 border border-slate-300 hover:border-amber-400 text-[11px] sm:text-xs font-bold flex items-center space-x-1 sm:space-x-1.5 transition-all shadow-2xs cursor-pointer"
              title="Admin Panel"
            >
          ...
          <div className="max-w-7xl mx-auto w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1.5 sm:gap-2">
            ...
            <div className="flex items-center space-x-3 text-[11px] shrink-0">
              ...
              >
                ...
                <span className="hidden sm:inline">लॉगिन (Login)</span>
              ...
              <button
                type="button"
                onClick={() => setIsQrStudioOpen(true)}
                className="text-emerald-900 font-bold hover:underline flex items-center space-x-1 pl-2 border-l border-amber-900/20 cursor-pointer"
              >
              ...
              <button
                onClick={() => setIsAdminOpen(true)}
                className="text-amber-900 font-bold hover:underline flex items-center space-x-1 pl-2 border-l border-amber-900/20 cursor-pointer"
              >
      ...
      {/* 8. MULTI-ROLE INSTITUTIONAL MANAGEMENT PORTAL MODAL */}
      <MultiRolePortalModal
        isOpen={isPortalOpen}
        onClose={() => setIsPortalOpen(false)}
        records={records}
        onPreviewStudentCard={(student) => {
          setCardData(student);
          setIsSubmitted(true);
          triggerConfetti();
        }}
